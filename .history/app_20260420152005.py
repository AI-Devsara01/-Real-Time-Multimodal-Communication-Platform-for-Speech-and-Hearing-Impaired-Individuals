...
# import ONLY these from your file
from num import ReliableASLRecognizer, VoiceEngine
...
# init model (NO voice for web)
recognizer = ReliableASLRecognizer(voice_engine=None)

@app.post("/api/number-recognition")
async def number_recognition(frame: UploadFile = File(...)):
    try:
        ...
        _, digit, confidence = recognizer.process_frame(img)
