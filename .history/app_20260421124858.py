...
PAGES = [
    ...
    "mood_journal", "communication_cards",
]
...
# ══════════════════════════════════════════════
#  TEXT-TO-SPEECH API (FIXED - No file issues)
# ══════════════════════════════════════════════

@app.route("/api/tts", methods=["POST"])
def api_tts():
    """TTS endpoint using BytesIO - no temporary files! Works for all languages"""
    try:
        ...
        # Save to BytesIO instead of file (no Windows file locking issues!)
        mp3_fp = BytesIO()
...
# ══════════════════════════════════════════════
#  NEW FEATURE 5 — LIP SYNC READER
# ══════════════════════════════════════════════

@app.route("/api/communication_cards", methods=["POST"])
def api_communication_cards():
    data   = request.json
